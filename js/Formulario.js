...
const translations = {
  es: {
    ...
    "header.role": "QA Engineer | Manual & Automation Web y Mobile | API Testing | Azure DevOps | Atlassian",
    ...
    "exp.datasystem.bullet1": "Especialista en Análisis de Requerimientos y Testing Funcional de Caja Negra.",
    "exp.datasystem.bullet2": "Desarrollador de estrategias de prueba efectivas y proactividad en resolución de incidencias.",
    "exp.pcivil.role": "Coordinador de Procesos Informáticos",
    "exp.pcivil.date": "octubre 2011 — mayo 2017",
    "exp.pcivil.country": "Venezuela",
    "exp.pcivil.bullet1": "Ejecución de pruebas sistemáticas y rigurosas para asegurar la calidad del software institucional.",
    "exp.pcivil.bullet2": "Creación y análisis de métricas para optimizar la eficiencia del proceso de testing.",
    "exp.pcivil.bullet3": "Coordinación de reportes de bugs y mantenimiento de infraestructura tecnológica.",
    "portfolio.label": "Portfolio",
    "portfolio.title": "Proyectos Destacados",
    "portfolio.project.title": "Brubank — Proyectos QA",
    "portfolio.bullet1": "Fail-Over, Promociones V1 y V2, Patear, FCI, Invitaciones, Pyme, QR V1 y V2, Tarjetas de Crédito y Débito.",
    "portfolio.bullet2": "Pruebas funcionales en Front-End, Back-End y plataformas móviles (Android / iOS).",
    ...
    "tabs.qa": "QA/Testing",
    "tabs.devops": "DevOps/Herramientas",
    "tabs.agile": "Metodología Ágil",
    "tabs.ia": "IA/ML",
    "tabs.otros": "Bootcamps/Otros",
    "diploma.programacion": "Programación Desde Cero",
    "diploma.html5": "HTML5 Fundamentos",
    "diploma.frontend": "Front-End JS 2025 (PDF)",
    "diploma.htmlcss": "HTML y CSS - Arg Programa 4.0",
    "diploma.qatester": "QA Tester",
    "diploma.qavanzado": "QA Avanzado",
    "diploma.academiaqa": "AcademiaQA Testing",
    "diploma.fstc": "Fundamental Testing Certified (PDF)",
    "diploma.linux": "Linux Comando",
    "diploma.git": "Git & GitHub 2026 (PDF)",
    "diploma.scrum": "Metodología Scrum",
    "diploma.scrumfund": "Scrum Fundamentals",
    "diploma.ia": "Introducción a IA 2025 (PDF)",
    "diploma.iaagentes": "IA: De 0 a Agentes",
    "diploma.argprog": "Argentina Programa",
    "diploma.argprog2021": "Arg Programa Oct-Dic 2021 (PDF)",
    "diploma.bootcamps": "Introducción a Bootcamps (PDF)",
    "diploma.entrevistas": "Entrevistas Laborales IT",
    "diploma.githubperfil": "GitHub: Perfil Profesional",
    "diploma.bddsql": "Bases de Datos y SQL",
    "diploma.ux": "Introducción a UX",
    ...
    "footer.form.msg": "Mensaje",
    "footer.form.placeholder.name": "Tu nombre",
    "footer.form.placeholder.email": "Tu email",
    "footer.form.placeholder.msg": "Tu mensaje",
    "footer.form.submit": "Enviar mensaje",
    "footer.form.sending": "Enviando...",
    "footer.form.success": "¡Mensaje enviado con éxito! Me pondré en contacto pronto.",
    "footer.form.error": "Error al enviar el mensaje. Por favor, intenta de nuevo.",
    "footer.form.required": "Por favor, completa todos los campos.",
    "footer.form.invalid_email": "Por favor, ingresa un correo electrónico válido.",
    "footer.form.short_msg": "El mensaje debe tener al menos 10 caracteres.",
    "footer.form.sending_msg": "Enviando mensaje...",
    "footer.copyright": "Todos los derechos reservados.",
    "exp.brubank.calculating": "calculando...",
    "exp.and": " y ",
    "exp.year_singular": " año",
    "exp.year_plural": " años",
  ...
  en: {
    "head.title": "CV - Ali Valentin Tovar Morales | QA Engineer",
    "header.role": "QA Engineer | Manual & Automation Web & Mobile | API Testing | Azure DevOps | Atlassian",
    "header.location": "Buenos Aires, Argentina",
    ...
    "exp.datasystem.country": "Argentina",
    "exp.datasystem.bullet1": "Requirements Analysis and Black Box Functional Testing specialist.",
    "exp.datasystem.bullet2": "Development of effective test strategies and proactive incident resolution.",
    "exp.pcivil.role": "IT Processes Coordinator",
    "exp.pcivil.date": "October 2011 — May 2017",
    "exp.pcivil.country": "Venezuela",
    "exp.pcivil.bullet1": "Execution of systematic and rigorous tests to ensure institutional software quality.",
    "exp.pcivil.bullet2": "Creation and analysis of metrics to optimize testing process efficiency.",
    "exp.pcivil.bullet3": "Bug report coordination and technological infrastructure maintenance.",
    "portfolio.label": "Portfolio",
    "portfolio.title": "Highlighted Projects",
    "portfolio.project.title": "Brubank — QA Projects",
    "portfolio.bullet1": "Fail-Over, Promotions V1 & V2, Patear, FCI, Invitations, Pyme, QR V1 & V2, Credit & Debit Cards.",
    "portfolio.bullet2": "Functional testing on Front-End, Back-End, and mobile platforms (Android / iOS).",
    ...
    "tabs.qa": "QA/Testing",
    "tabs.devops": "DevOps/Tools",
    "tabs.agile": "Agile Methodology",
    "tabs.ia": "AI/ML",
    "tabs.otros": "Bootcamps/Other",
    "diploma.programacion": "Programming From Scratch",
    "diploma.html5": "HTML5 Fundamentals",
    "diploma.frontend": "Front-End JS 2025 (PDF)",
    "diploma.htmlcss": "HTML & CSS - Arg Programa 4.0",
    "diploma.qatester": "QA Tester",
    "diploma.qavanzado": "Advanced QA",
    "diploma.academiaqa": "AcademiaQA Testing",
    "diploma.fstc": "Fundamental Testing Certified (PDF)",
    "diploma.linux": "Linux Command Line",
    "diploma.git": "Git & GitHub 2026 (PDF)",
    "diploma.scrum": "Scrum Methodology",
    "diploma.scrumfund": "Scrum Fundamentals",
    "diploma.ia": "Introduction to AI 2025 (PDF)",
    "diploma.iaagentes": "AI: From 0 to Agents",
    "diploma.argprog": "Argentina Programa",
    "diploma.argprog2021": "Arg Programa Oct-Dec 2021 (PDF)",
    "diploma.bootcamps": "Introduction to Bootcamps (PDF)",
    "diploma.entrevistas": "IT Job Interviews",
    "diploma.githubperfil": "GitHub: Professional Profile",
    "diploma.bddsql": "Databases and SQL",
    "diploma.ux": "Introduction to UX",
    ...
    "footer.form.msg": "Message",
    "footer.form.placeholder.name": "Your name",
    "footer.form.placeholder.email": "Your email",
    "footer.form.placeholder.msg": "Your message",
    "footer.form.submit": "Send message",
    "footer.form.sending": "Sending...",
    "footer.form.success": "Message sent successfully! I'll get back to you soon.",
    "footer.form.error": "Error sending message. Please try again.",
    "footer.form.required": "Please fill in all fields.",
    "footer.form.invalid_email": "Please enter a valid email address.",
...
function setLanguage(lang) {
  ...
  // Update Spanish skill tags
  document.querySelectorAll('[data-i18n-skill]').forEach(el => {
  ...
  if (langToggle) {
    ...
    langToggle.setAttribute('aria-label', getTranslation(lang === 'es' ? 'lang.aria' : 'lang.aria.en'));
  }
